...
path_dir = r'C:\Users\a.acar\PycharmProjects\VaR\var_dash\pythonsp500-plotly-dash-master'
tickers = pd.read_csv(path_dir + r'\tickers.csv')
tickers.set_index('Ticker', inplace=True)

data = pd.read_csv(path_dir + r'\analyzed_portfolio.csv')
...
app.layout = html.Div([
    ...
    dcc.Graph(id='cvh1',
              figure={'data': [
                  ...
                  go.Scatter(
                      x=data['Ticker #'][0:20],
                      y=[-0.25, -0.25, -0.25, -0.25, -0.25, -0.25, -0.25, -0.25, -0.25, -0.25, -0.25, -0.25,
